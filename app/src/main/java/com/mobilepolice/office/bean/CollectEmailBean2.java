...
public class CollectEmailBean2 {
    ...
    public static class ObjBean implements Comparable<ObjBean>,Parcelable {
         ...
         * attach : {"fileName":"数据资源整合（中管）.docx","filePath":"http://10.106.12.104:8789/mailfile/1551162726660.docx"}
        ...
        public static class AttachBean implements Parcelable {
            /**
             * fileName : 数据资源整合（中管）.docx
             * filePath : http://10.106.12.104:8789/mailfile/1551162726660.docx
             */
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeParcelable(this.attach, flags);
        ...
        protected ObjBean(Parcel in) {
            ...
            this.attach = in.readParcelable(AttachBean.class.getClassLoader());
