 ...
 * 已审批
 */
public class ApprovedPendingWorkAdapter extends BaseQuickAdapter<PendingWorkBean, BaseViewHolder> {
    public ApprovedPendingWorkAdapter() {
        super(R.layout.item_grid_approved, null);
    }
