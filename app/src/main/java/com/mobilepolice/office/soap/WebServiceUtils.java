package com.mobilepolice.office.soap;
...
public class WebServiceUtils {
    ...
    public static void getRequest(final String methodName, final SoapParams params, final CallBack callBack) {
        // 用于子线程与主线程通信的Handler
        final Handler mHandler = new Handler() {
            @Override
            public void handleMessage(Message msg) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                //  String methodName = methodNames;
                // EndPoint
                String endPoint = Config.REQUEST_URL;//"http://www.freetk.cn:8789/mobileworkws/services/MobileWorkws?wsdl";
                // SOAP Action
                // final String soapAction = "http://services.webservice.mobilework.com/findApplyPersonDeptName";
                // 建立webservice连接对象
                final HttpTransportSE transport = new HttpTransportSE(endPoint);
